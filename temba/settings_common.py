...
# if your site was at http://im3nsa.io, it might look like this:
# -----------------------------------------------------------------------------------
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'server@im3nsa.io'
DEFAULT_FROM_EMAIL = 'server@im3nsa.io'
EMAIL_HOST_PASSWORD = 'mypassword'
EMAIL_USE_TLS = True

# Used when sending email from within a flow and the user hasn't configured
# their own SMTP server.
FLOW_FROM_EMAIL = 'no-reply@im3nsa.io'
...
AWS_STORAGE_BUCKET_NAME = 'dl-im3nsa-io'
...
BRANDING = {
    'im3nsa.io': {
        ...
        'styles': ['brands/im3nsa/font/style.css'],
        'welcome_topup': 1000,
        'email': 'join@rapidpro.io',
        'support_email': 'support@im3nsa.io',
        'link': 'https://app.im3nsa.io',
        'api_link': 'https://api.im3nsa.io',
        'docs_link': 'http://docs.im3nsa.io',
        'domain': 'app.im3nsa.io',
        'favico': 'brands/im3nsa/im3nsa.ico',
        'splash': '/brands/im3nsa/splash.jpg',
        'logo': '/brands/im3nsa/logo.png',
        'allow_signups': True,
        'tiers': dict(import_flows=0, multi_user=0, multi_org=0),
        'bundles': [],
        'welcome_packs': [dict(size=5000, name="Demo Account"), dict(size=100000, name="UNICEF Account")],
        'description': _("Visually build scalable SMS-based, interactive applications from anywhere."),
        'credits': _("Copyright &copy; 2018 Abdul Meque. All Rights Reserved.")
    }
}
